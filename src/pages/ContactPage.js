      ...
      <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center">
                ...
                <a href="tel:+393426623721" className="hover:text-yellow-500 text-green-800 transition-colors">+39 342 662 3721</a>
              </li>
              <li className="flex items-center">
                <FaEnvelope className="mr-2 text-yellow-500" />
                <a href="mailto:parcolacascina@gmail.com" className="hover:text-yellow-500 text-green-800  transition-colors">parcolacascina@gmail.com</a>
              </li>
              <li className="flex items-center">
                <FaMapMarkerAlt className="mr-2 text-yellow-500 " />
                <p className='text-green-800 '> Via dei Canneti, 1, 21020 Bodio Lomnago VA</p>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="mb-2 text-green-800 ">Lunedì - Venerdì: 9:00 - 18:00</p>
            <p className="mb-2 text-green-800 ">Sabato: 9:00 - 13:00</p>
            <p className="text-green-800">Domenica: Chiuso</p>
          </div>
        </div>
      </div>
